...
def main():
  ...
  while True:
    ...
    if len(guess) == 4 and guess.isdigit() and len(set(guess)) == 4:
      ...
      print(f'Thanks for playing! Your number was {secret}')
      break
    else:
